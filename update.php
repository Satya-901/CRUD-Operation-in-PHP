...
<body>
  ...
  <div class="Container mt-5">
    <div class="row">
      <div class="col-2"></div>
      <div class="col-8 box">
        <h3 class="mb-3 text-center"><u>update Form</u></h3>
<!--  -->
<?php
$ids = $_GET['id'];
$values = "SELECT * FROM `form` WHERE id={$ids}";
$valuequery = mysqli_query($conn, $values);
$arrdata = mysqli_fetch_array($valuequery);
          ...
          <div class="mb-3">
            <div class="row">
              <div class="col-6">
                ...
                <input type="text" class="form-control" value="<?php echo $arrdata['fname'];  ?>" id="fname" name="fname" />
              </div>
              <div class="col-6">
                <h6 for="lname" class="form-label">LAST NAME:</h6>
                <input type="text" name="lname" value="<?php echo $arrdata['lname'] ?>" id="lname" class="form-control" />
              </div>
            </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <div class="row">
              <div class="col-6">
                ...
                <input type="email" name="email" value="<?php echo $arrdata['email'] ?>" id="email" class="form-control" />
              </div>
              <div class="col-6">
                <h6 for="mobile" class="form-label">MOBILE NO.:</h6>
                <input type="number" name="mobile" value="<?php echo $arrdata['mobile'] ?>" id="mobile" class="form-control" />
              </div>
            </div>
          </div>
          <div class="mb-3">
